...
try
  ...
  fprintf('Trying to compile MEX file for solid_angle');
  cd(mexdir);
  if ispc
  ...
  % compilation failed
  disp(lasterr);
  fprintf('Could not compile MEX file, using slower Matlab implementation');
  cd(pwdir);
  success = false;
end
...
if success
  ...
  [varargout{1:nargout}] = funhandle(varargin{:});
    ...
    % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % The section contains the plain MATLAB implementation. The mex file
    ...
    elseif nargin==3
		...
		r1 = varargin(1); r2 = varargin(2); r3 = varargin(3);
